...
class HTParser(rfc822.Message):
    ...
    def process_sidebar(self, UseAltCRE = None):
    ...
    def __parse(self, text, UseAltCRE):
        ...
        while 1:
            if UseAltCRE:
                mo = self.alt_cre.search(text, start)
            else:
