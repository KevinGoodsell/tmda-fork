...
class Skeleton:
    ...
    def makepage(self):
        ...
        try:
            ...
            print '<table %s border="0" cellspacing="0" cellpadding="0">' % \
                self.get_body_metrics()
            if banner is not None:
                ...
                print '<td %s class="banner">%s</td><!-- end of banner -->' % (
                    self.get_banner_metrics(), banner)
            ...
            # table twice
            if sidebar is None:
                print '%s</table><!-- end of page table -->' % \
                    self.get_body_close()
                closed = 1
            else:
    ...
    def __do_corner(self, corner):
        ...
        temp = '<td %s valign="middle" bgcolor="%s" class="corner">' \
              % (self.get_corner_metrics(), self.get_corner_bgcolor())
    ...
    def __do_sidebar(self, sidebar):
        ...
        print '<td %s valign="top" class="sidebar">' % \
            self.get_sidebar_table_metrics()
        print sidebar
        print '</td>'
        if self.use_spacers():
    ...
    def __do_body(self, body):
        ...
        print '<td valign="top" class="body">%s</td>' % body
        print '<!-- end of body cell -->'
